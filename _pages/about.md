...
**[`Substack`](https://aisagroup.substack.com/)** &emsp; 
**[`X`](https://x.com/maksym_andr)** &emsp; 
**[`Scholar`](https://scholar.google.com/citations?user=ZNtuJYoAAAAJ)** &emsp; 
**[`GitHub`](https://github.com/max-andr)** &emsp; 
**[`CV`](cv.pdf)**


👋 **Short bio.** I am a principal investigator at the [ELLIS Institute Tübingen](https://institute-tue.ellis.eu/) and the [Max Planck Institute for Intelligent Systems](https://is.mpg.de/), where I lead the AI Safety and Alignment group. Recently, I served as chapter lead for the [International AI Safety Report 2026](https://arxiv.org/abs/2501.17805) chaired by Prof. Yoshua Bengio. I collaborate closely with industry: I have participated in red-teaming efforts for OpenAI and Anthropic models, and the benchmarks I co-authored have been used by [DeepMind](https://arxiv.org/abs/2403.05530), [Meta](https://ai.meta.com/static-resource/muse-spark-safety-and-preparedness-report/), [xAI](https://data.x.ai/2025-08-20-grok-4-model-card.pdf), and [Anthropic / UK AI Safety Institute](https://cdn.prod.website-files.com/663bd486c5e4c81588db7a1d/673b689ec926d8d32e889a8e_UK-US-Testing-Report-Nov-19.pdf). I obtained my PhD in machine learning from EPFL in 2024, supported by the [Google](https://research.google/outreach/phd-fellowship/recipients/) and [Open Phil AI](https://www.openphilanthropy.org/grants/open-phil-ai-fellowship-2022-class/) PhD Fellowships. My PhD thesis received the [ELLIS PhD Award](https://ellis.eu/news/the-ellis-phd-award-2025-recognizes-four-young-scientists-from-universities-in-tubingen-lausanne-zurich-vienna) and [Patrick Denantes Memorial Prize at EPFL](https://www.epfl.ch/education/phd/edic-computer-and-communication-sciences/edic-computer-and-communication-sciences/edic-patrick-denantes-memorial-prize/). 
<!-- Before that, I completed my MSc at Saarland University and the University of Tübingen, and interned at Adobe Research. -->

<div style="border-left: 4px solid #2e7d32; padding: 0.8rem 1rem; margin: 1.5rem 0; background-color: rgba(46, 125, 50, 0.05); border-radius: 0 4px 4px 0;">
<p style="margin-bottom: 0;">🎓 <strong>AI Safety Course (Summer Semester 2026).</strong> <a href="https://s-abdelnabi.github.io/">Sahar Abdelnabi</a>, <a href="https://jonasgeiping.github.io/">Jonas Geiping</a>, and I are teaching a new AI safety course at the University of Tübingen. All materials are openly available in <strong><a href="https://github.com/aisa-group/tue-ai-safety-course">our GitHub repository</a></strong>.</p>
</div>
...
4. [David Schmotz](https://www.linkedin.com/in/david-schmotz-840660150/) (PhD student)
...
9. [Akshit Sinha](https://akshitsinha3.com/) (incoming PhD student, co-supervised with [Jakob Foerster](https://www.jakobfoerster.com/))
10. [Fabian Grob](https://www.linkedin.com/in/fabian-grob/) (incoming PhD student, co-supervised with [Yonatan Belinkov](https://belinkov.com/))
11. [Changling Li](https://changlingli.com/) (incoming PhD student, main advisor [Rediet Abebe](https://en.wikipedia.org/wiki/Rediet_Abebe))
...
2. Etienne Bonvin (master's project at EPFL → Security Engineer at Global ID SA)
3. Klim Kireev (PhD project at EPFL → PhD student at EPFL, researcher at MPI-SP)
4. Edoardo Debenedetti (master's project at EPFL → PhD student at ETH Zurich)
5. Mehrdad Saberi (Summer@EPFL intern → PhD student at University of Maryland)
6. Jana Vuckovic (master's project at EPFL → Data Science Intern at Credit Suisse)
7. Théau Vannier (master's project at EPFL → Research Engineer at InstaDeep)
8. Francesco d'Angelo (PhD project at EPFL → PhD student at EPFL, Google PhD Fellowship)
9. Tiberiu Musat (bachelor's project at EPFL → MSc student at ETH Zurich)
10. Hichem Hadhri (master's project at EPFL → Data Science Intern at Swisscom)
11. Hao Zhao (master's thesis at EPFL → PhD student at EPFL)
12. Joshua Freeman (master's project at ETH Zurich → SWE Intern at Meta)
13. [Anietta Weckauff](https://www.linkedin.com/in/anietta-weckauff/) (research intern)
14. [Raffaele Mura](https://rmura498.github.io/) (research intern)
15. [Yuchen Zhang](https://zycalice.github.io/) (research intern)
